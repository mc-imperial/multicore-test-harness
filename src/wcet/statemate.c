 ...
 * the STAtechart Real-time_global-Code generator STARC
...
void interface(void)
{
   ...
   tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL = time_global;
   ...
   tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL = time_global;
   if ((sc_FH_TUERMODUL_CTRL_2375_2 != 0) && (time_global - sc_FH_TUERMODUL_CTRL_2375_2 >= 0.5))
   {
      FH_TUERMODUL__MFHA_copy = 0;
      sc_FH_TUERMODUL_CTRL_2375_2 = 0;
      
   }
   if ((sc_FH_TUERMODUL_CTRL_2352_1 != 0) && (time_global - sc_FH_TUERMODUL_CTRL_2352_1 >= 0.5))
   {
      FH_TUERMODUL__MFHZ_copy = 0;
      sc_FH_TUERMODUL_CTRL_2352_1 = 0;
      
   }
   if ((sc_FH_TUERMODUL_CTRL_2329_1 != 0) && (time_global - sc_FH_TUERMODUL_CTRL_2329_1 >= 0.5))
   {
      FH_TUERMODUL__MFHZ_copy = 0;
      sc_FH_TUERMODUL_CTRL_2329_1 = 0;
      
   }
   if ((sc_FH_TUERMODUL_CTRL_1781_10 != 0) && (time_global - sc_FH_TUERMODUL_CTRL_1781_10 >= 0.5))
   {
      sc_FH_TUERMODUL_CTRL_1781_10 = 0;
      
   }
   if ((sc_FH_TUERMODUL_CTRL_1739_10 != 0) && (time_global - sc_FH_TUERMODUL_CTRL_1739_10 >= 0.5))
   {
   ...
   tm_entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRLch_BLOCK_ERKENNUNG_CTRL__N_copy = time_global;
   ...
   if (SYS_bit_get(Bitlist,active_FH_TUERMODUL_CTRL_IDX))
   {
      ...
      switch (B_FH_TUERMODUL_CTRL_next_state)
      {
         ...
         case 2 : /** state NICHT_INITIALISIERT in chart FH_TUERMODUL_CTRL **/
         {
            if (((FH_TUERMODUL__BLOCK && !(FH_TUERMODUL__BLOCK_old))) && ((FH_TUERMODUL__MFHZ)))
            {
               stable = 0;
               FH_TUERMODUL__MFHZ_copy = 0;
               sc_FH_TUERMODUL_CTRL_2329_1 = time_global;
         ...
         case 3 : /** state INITIALISIERT in chart FH_TUERMODUL_CTRL **/
         {
            ...
            if (((FH_TUERMODUL__BLOCK && !(FH_TUERMODUL__BLOCK_old))) && ((FH_TUERMODUL__MFHA)))
            {
               stable = 0;
               FH_TUERMODUL__MFHA_copy = 0;
               sc_FH_TUERMODUL_CTRL_2375_2 = time_global;
            ...
            if (((FH_TUERMODUL__BLOCK && !(FH_TUERMODUL__BLOCK_old))) && ((FH_TUERMODUL__MFHZ)))
            {
               stable = 0;
               FH_TUERMODUL__MFHZ_copy = 0;
               sc_FH_TUERMODUL_CTRL_2352_1 = time_global;
                        ...
                        switch (TIPP_SCHLIESSEN_FH_TUERMODUL_CTRL_next_state)
                        {
                           ...
                           case 2 : /** state TIPP_SCHLIESSEN1 in chart FH_TUERMODUL_CTRL **/
                           {
                              if (SYS_bit_get (Bitlist, FH_TUERMODUL__EINKLEMMUNG_IDX))
                              {
                                 ...
                                 sc_FH_TUERMODUL_CTRL_1781_10 = time_global;
                                 FH_TUERMODUL__MFHA_copy = 1;
                                 break;
                              }
                              break;
                        ...
                        switch (MANUELL_SCHLIESSEN_FH_TUERMODUL_CTRL_next_state)
                        {
                           ...
                           case 2 : /** state MAN_SCHLIESSEN in chart FH_TUERMODUL_CTRL **/
                           {
                              if (SYS_bit_get (Bitlist, FH_TUERMODUL__EINKLEMMUNG_IDX))
                              {
                                 ...
                                 sc_FH_TUERMODUL_CTRL_1739_10 = time_global;
                                 FH_TUERMODUL__MFHA_copy = 1;
                                 break;
                              }
                              if ((FH_TUERMODUL__SFHA && !(FH_TUERMODUL__SFHA_old)))
      ...
      switch (A_FH_TUERMODUL_CTRL_next_state)
      {
         case 1 : /** state WIEDERHOLSPERRE in chart FH_TUERMODUL_CTRL **/
         {
            ...
            if ((step == 1 && tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL != 0 && (time_global - tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRLexited_BEREIT_FH_TUERMODUL_CTRL == 1)) && ((FH_TUERMODUL__MFHZ || FH_TUERMODUL__MFHA)))
            {
               stable = 0;
            ...
            switch (WIEDERHOLSPERRE_FH_TUERMODUL_CTRL_next_state)
            {
               ...
               {
                  if ((step == 1 && tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL != 0 && (time_global - tm_entered_WIEDERHOLSPERRE_FH_TUERMODUL_CTRL == 3)) && (((!(FH_TUERMODUL__MFHZ || FH_TUERMODUL__MFHA)) && FH_TUERMODUL_CTRL__N > 0)))
                  {
                     stable = 0;
                     FH_TUERMODUL_CTRL__N = FH_TUERMODUL_CTRL__N - 1;
            ...
            switch (BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state)
            {
               ...
               case 3 : /** state EINSCHALTSTROM_MESSEN in chart BLOCK_ERKENNUNG_CTRL **/
               {
                  ...
                  if (BEWEGUNG_BLOCK_ERKENNUNG_CTRL_next_state == 3)
                       {
                          if (step == 1 && tm_entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRLch_BLOCK_ERKENNUNG_CTRL__N_copy != 0 && (time_global - tm_entered_EINSCHALTSTROM_MESSEN_BLOCK_ERKENNUNG_CTRLch_BLOCK_ERKENNUNG_CTRL__N_copy == 0.002))
                     {
